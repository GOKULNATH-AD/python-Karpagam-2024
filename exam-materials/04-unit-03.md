...
1. Discuss the importance of function scope and variable scope with examples.
...
1. Explain the limitations of lambda functions and when it is preferable to use regular functions.
1. Write a program using a lambda function to check whether a number is divisible by 3.
1. How does the use of lambda functions improve code readability in some cases? Provide an example.
...
1. How can you list all the modules in a Python package?  
...
1. Explain the basic operations that can be performed on a NumPy array with examples.  
1. Write a Python program to create a pandas DataFrame and perform basic data manipulation (like sorting, filtering).  
1. Explain how to visualize data using matplotlib with a simple example of creating a bar chart.  
1. Write a simple Flask web application that accepts user input and displays it on a webpage.  
1. Compare Flask and Django in terms of their features and use cases with examples.  
1. Write a program to plot a simple graph using matplotlib, showing multiple lines with different styles and colors.  
1. Demonstrate how to perform basic data analysis (like summing columns or calculating averages) using pandas.  
1. Write a Python program using NumPy to perform element-wise operations on arrays (like addition, subtraction, multiplication).
